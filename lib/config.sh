...
BASE_PROFILES["movie"]="title=Standard Movie:preset=slow:crf=22:pix_fmt=yuv420p10le:profile=main10:no-sao:bframes=6:b-adapt=2:ref=4:psy-rd=1.5:psy-rdoq=2.0:aq-mode=2:aq-strength=0.9:deblock=-1,-1:rc-lookahead=40:merange=57:max-tu-size=32:ctu=64:rd=4:rdoq-level=2:qcomp=0.70:weightb:weightp:cutree:me=hex:subme=3:base_bitrate=12000:hdr_bitrate=15000:content_type=mixed"
BASE_PROFILES["movie_mid_grain"]="title=Movies with lighter grain:preset=slow:crf=21:pix_fmt=yuv420p10le:profile=main10:no-sao:bframes=6:b-adapt=2:ref=4:psy-rd=2.0:psy-rdoq=2.5:aq-mode=2:aq-strength=0.8:deblock=-2,-2:rc-lookahead=40:merange=57:max-tu-size=32:ctu=64:rd=4:rdoq-level=2:qcomp=0.65:weightb:weightp:cutree:me=hex:subme=4:rskip=2:rskip-edge-threshold=2:rect:no-strong-intra-smoothing:base_bitrate=12000:hdr_bitrate=15000:content_type=mixed"
...
BASE_PROFILES["anime"]="title=Anime:preset=slow:crf=23:pix_fmt=yuv420p10le:profile=main10:limit-sao=1:deblock=1,1:aq-mode=3:aq-strength=0.8:psy-rd=1.1:psy-rdoq=1.0:rskip=2:rskip-edge-threshold=2:bframes=5:b-adapt=2:ref=6:rc-lookahead=80:ctu=64:rd=4:rdoq-level=2:qcomp=0.75:keyint=240:min-keyint=24:me=hex:subme=6:merange=57:base_bitrate=12000:hdr_bitrate=15000:content_type=anime"
BASE_PROFILES["classic_anime"]="title=Classic 90s Anime with finer details:preset=slow:crf=22:pix_fmt=yuv420p10le:profile=main10:limit-sao=1:deblock=0,0:aq-mode=3:aq-strength=0.8:psy-rd=0.9:psy-rdoq=1.0:rskip=2:rskip-edge-threshold=2:bframes=5:b-adapt=2:ref=6:rc-lookahead=50:ctu=64:rd=4:rdoq-level=2:qcomp=0.75:keyint=240:min-keyint=24:me=hex:subme=5:merange=57:base_bitrate=12000:hdr_bitrate=15000:content_type=classic_anime"
